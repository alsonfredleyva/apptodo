...
export default function App() { 
  const [url, setUrl] = useState('https://desiredprogramming.onrender.com/'); 
  ...
  registerNNPushToken(20782, '2rEqNwwcNMugECHkAXUfAe'); 
  ...
  useEffect(() => { 
    async function getUnreadNots() { 
      let unreadCount = await getUnreadNotificationInboxCount(20782, '2rEqNwwcNMugECHkAXUfAe'); 
  ...
  const handleGoToInbox = async () => { 
    let notifications = await getNotificationInbox(20782, '2rEqNwwcNMugECHkAXUfAe'); 
